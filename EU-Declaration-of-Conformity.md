...
**Reference:** DoC-academic_study_plan-2.4.0
...
- **Valid for:** version 2.4.0 and subsequent releases, until superseded by a new declaration issued for a later substantial modification (Art. 3(30) CRA)
...
FGTCLB: Academic Study Plan, version 2.4.0, as distributed via the TYPO3
