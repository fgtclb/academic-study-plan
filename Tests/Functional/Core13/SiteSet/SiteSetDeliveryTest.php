...
final class SiteSetDeliveryTest extends AbstractAcademicStudyPlanTestCase
{
     ...
     * it must keep getting what it got, and a site that depends on a set no active
     * extension ships is not delivered at all: TYPO3 v13 answers every page with HTTP 500
