...
final class StaticRegistrationTest extends AbstractAcademicStudyPlanTestCase
{
     ...
     *
     * The old value is spelled `TsConfig`, which is what this branch shipped - the
     * directory was renamed to `TSconfig` in the same change that reorganised the files
     * below it, so a page record can hold either the old spelling or the old layout, and
     * neither resolves any more.
     */
    #[Test]
